<template>
  <div style="margin-top: 30px;">
    <div style="float: left;">
      ...
      <el-button type="primary" @click="showChargeDialog">充值</el-button>
    </div>
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline" style="float: right;">
      ...
      <el-dialog title="分销商充值" :visible.sync="dialogFormVisible" size="tiny" >
        <el-form :model="form" ref="form" :rules="rules" style="margin-right: 50px;" v-loading="dialogLoading">
          ...
          <el-form-item label="充值金额(元)" :label-width="formLabelWidth" prop="value">
          ...
          <el-form-item :label-width="formLabelWidth">
            <el-button type="primary" @click="submitForm('ruleForm')" :loading="SubBtnLoading" :disabled="SubBtnDisabled">充值</el-button>
...
<script>
import { getrechargelog, recharge, dislist } from '@/api/api'
export default {
  data () {
